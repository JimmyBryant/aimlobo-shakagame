...
const intervalMinutes = 6; // 间隔时间（分钟）-- 非常重要 -- 一定要 >= 1,才能正确更新list页面的数据（按条）
...
const singleBetBonus = 100000; // 单注奖励
const taxRate = 0.03; // 扣去多少作为服务费
const minPlayerNumber = 4000; // 模拟的参与人数下限
const maxPlayerNumber = 15000; // 模拟的参与人数上限
const minWinners = 0; // 模拟的中奖人数下限
const maxWinners = 5; // 模拟的中奖人数上限
...
const winningNumberParts = 5; // 中奖号码的位数
const winningNumberLowest = 0; // 中奖号码的最低数字
const winningNumberHighest = 99999; // 中奖号码的最高数字



// 参数变量，写入local
// 一级名称
const keyName_1_00 = 'game_toto_5';
